...
#Aufgabe 01_aschenbroedel; Musterloesung:
...
#Ueberpruefung: 
 ...
 muster_lsg  = try(instoepfchen_muster_lsg(erbsen = c(0L, 1L, 0L, 1L, 0L, 1L), gut = 1L)) #Ergebnis der Musterloesung
...
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
 ...
 muster_lsg  = try(instoepfchen_muster_lsg(erbsen = c(0L, 0L, 1L, 1L, 1L, 1L), gut = 0L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test3
 einreichung = try(instoepfchen(erbsen = c(0L, 1L, 1L, 1L, 1L, 1L), gut = 1L)) #Ergebnis der Einreichung
 muster_lsg  = try(instoepfchen_muster_lsg(erbsen = c(0L, 1L, 1L, 1L, 1L, 1L), gut = 1L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test4
 einreichung = try(instoepfchen(erbsen = c(1L, 1L, 1L, 1L, 0L, 0L), gut = 0L)) #Ergebnis der Einreichung
 muster_lsg  = try(instoepfchen_muster_lsg(erbsen = c(1L, 1L, 1L, 1L, 0L, 0L), gut = 0L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test5
 einreichung = try(instoepfchen(erbsen = c(1L, 2L, 1L, 4L, 0L, 0L), gut = 2L)) #Ergebnis der Einreichung
 muster_lsg  = try(instoepfchen_muster_lsg(erbsen = c(1L, 2L, 1L, 4L, 0L, 0L), gut = 2L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
...
#Aufgabe 02_sommerhochwasser; Musterloesung:
...
#Ueberpruefung: 
 ...
 muster_lsg  = try(sommerhochwasser_muster_lsg(abfluss = c(1L, 7L, 3L, 2L, 4L, 8L, 3L, 8L, 7L, 3L, 5L, 1L), monat = c(1L, 2L, 7L, 4L, 9L, 10L, 6L, 8L, 5L, 11L, 12L, 3L), beginn = 5L, ende = 7L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
 ...
 muster_lsg  = try(sommerhochwasser_muster_lsg(abfluss = c(8L, 4L, 3L, 5L, 2L, 3L, 8L, 7L, 1L, 7L, 3L, 1L), monat = c(5L, 1L, 2L, 9L, 10L, 7L, 6L, 11L, 3L, 12L, 4L, 8L), beginn = 4L, ende = 9L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
 ...
 muster_lsg  = try(sommerhochwasser_muster_lsg(abfluss = c(3L, 3L, 3L, 1L, 8L, 7L, 4L, 8L, 1L, 2L, 5L, 7L), monat = c(5L, 1L, 3L, 10L, 4L, 8L, 12L, 2L, 6L, 9L, 7L, 11L), beginn = 5L, ende = 9L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
 ...
 muster_lsg  = try(sommerhochwasser_muster_lsg(abfluss = c(5L, 2L, 3L, 8L, 3L, 7L, 3L, 7L, 4L, 8L, 1L, 1L), monat = c(8L, 4L, 7L, 5L, 2L, 3L, 1L, 11L, 12L, 6L, 9L, 10L), beginn = 6L, ende = 10L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
...
#Aufgabe 03_gradtage; Musterloesung:
...
#Ueberpruefung: 
 ...
 muster_lsg  = try(gradtage_muster_lsg(temp = c(1L, 7L, 3L, 2L, 4L, 8L, 3L, 8L, 7L, 3L, 5L, 1L), minT = 2L, erntereif = 10L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test2
 einreichung = try(gradtage(temp = c(1L, 7L, 3L, 2L, 4L, 8L, 3L, 8L, 7L, 3L, 5L, 1L), minT = 4L, erntereif = 10L)) #Ergebnis der Einreichung
 muster_lsg  = try(gradtage_muster_lsg(temp = c(1L, 7L, 3L, 2L, 4L, 8L, 3L, 8L, 7L, 3L, 5L, 1L), minT = 4L, erntereif = 10L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test3
 einreichung = try(gradtage(temp = c(1L, 7L, 3L, 2L, 4L, 8L, 3L, 8L, 7L, 3L, 5L, 1L), minT = 4L, erntereif = 12L)) #Ergebnis der Einreichung
 muster_lsg  = try(gradtage_muster_lsg(temp = c(1L, 7L, 3L, 2L, 4L, 8L, 3L, 8L, 7L, 3L, 5L, 1L), minT = 4L, erntereif = 12L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test4
 einreichung = try(gradtage(temp = c(1L, 7L, 3L, 2L, 4L, 8L, 3L, 8L, 7L, 3L, 5L, 1L), minT = 4L, erntereif = 15L)) #Ergebnis der Einreichung
 muster_lsg  = try(gradtage_muster_lsg(temp = c(1L, 7L, 3L, 2L, 4L, 8L, 3L, 8L, 7L, 3L, 5L, 1L), minT = 4L, erntereif = 15L)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
...
#Ueberpruefung: 
 ...
 muster_lsg  = try(curveNumber1_muster_lsg(lanu1 = "Freiflaeche", lanu2 = "hoher Wiesenanteil", boden = "B")) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test2
 einreichung = try(curveNumber1(lanu1 = "Wohngebiet", lanu2 = "30% bebaut", boden = "A")) #Ergebnis der Einreichung
 muster_lsg  = try(curveNumber1_muster_lsg(lanu1 = "Wohngebiet", lanu2 = "30% bebaut", boden = "A")) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test3
 einreichung = try(curveNumber1(lanu1 = "Verkehrsflaeche", lanu2 = "Feldweg", boden = "A")) #Ergebnis der Einreichung
 muster_lsg  = try(curveNumber1_muster_lsg(lanu1 = "Verkehrsflaeche", lanu2 = "Feldweg", boden = "A")) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test4
 einreichung = try(curveNumber1(lanu1 = "Freiflaeche", lanu2 = "mittlerer Wiesenanteil", boden = "D")) #Ergebnis der Einreichung
 muster_lsg  = try(curveNumber1_muster_lsg(lanu1 = "Freiflaeche", lanu2 = "mittlerer Wiesenanteil", boden = "D")) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
...
#Ueberpruefung: 
 ...
 muster_lsg  = try(curveNumber2_muster_lsg(cn2 = 72L, precip = c(2L, 5L, 3L, 6L, 0L), vegetation = TRUE)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test2
 einreichung = try(curveNumber2(cn2 = 57L, precip = c(2L, 20L, 30L, 6L, 0L), vegetation = FALSE)) #Ergebnis der Einreichung
 muster_lsg  = try(curveNumber2_muster_lsg(cn2 = 57L, precip = c(2L, 20L, 30L, 6L, 0L), vegetation = FALSE)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test3
 einreichung = try(curveNumber2(cn2 = 63L, precip = c(2L, 1L, 3L, 1L, 0L), vegetation = FALSE)) #Ergebnis der Einreichung
 muster_lsg  = try(curveNumber2_muster_lsg(cn2 = 63L, precip = c(2L, 1L, 3L, 1L, 0L), vegetation = FALSE)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe

 #test4
 einreichung = try(curveNumber2(cn2 = 92L, precip = c(2L, 5L, 3L, 6L, 30L), vegetation = TRUE)) #Ergebnis der Einreichung
 muster_lsg  = try(curveNumber2_muster_lsg(cn2 = 92L, precip = c(2L, 5L, 3L, 6L, 30L), vegetation = TRUE)) #Ergebnis der Musterloesung
if (identical2(einreichung, muster_lsg)) kontrollergebnis_t$richtig[1] = kontrollergebnis_t$richtig[1] + 1 #zaehle richtige Ergebnisse
if (class(einreichung) == "try-error") kontrollergebnis_t$nicht_aufrufbar[1] = kontrollergebnis_t$nicht_aufrufbar[1] + 1 #zaehle fehlerhafte Aufrufe
