...
#Aber was heißt eigentlich "Sommer"? Das Argument `beginn` definiert den ersten Sommermonat und das Argument `ende` den letzten. Runden Sie das Ergebnis auf zwei Nachkommastellen (Funktion `round`).
#Beispiel:
#  In den Monaten `monat=c(1,3,5,7,9,11,2,4,6,8,10,12)` wurde der Spitzenabfluss
#  `abfluss=c(10,20,15,30,5,25,11,14,30,18,24,20)`  gemessen. Als Sommer gelten alle Monate von `beginn=6` bis `ende=9`. Der mittlere HW-Abfluss im	Sommer beträgt also 20.75  (Mittelwert aus 30, 5, 30 und 18).
